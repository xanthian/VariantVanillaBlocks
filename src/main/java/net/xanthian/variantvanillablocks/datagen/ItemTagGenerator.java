...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
    private static final TagKey<Item> C_BOOKSHELF = TagKey.of(Registries.ITEM.getKey(), Identifier.of("c:bookshelves"));
    private static final TagKey<Item> C_CHESTS = TagKey.of(Registries.ITEM.getKey(), Identifier.of("c:chests"));
    ...
    private static final TagKey<Item> C_WOODEN_BARRELS = TagKey.of(Registries.ITEM.getKey(), Identifier.of("c:wooden_barrels"));
    private static final TagKey<Item> C_WOODEN_CHESTS = TagKey.of(Registries.ITEM.getKey(), Identifier.of("c:wooden_chests"));
