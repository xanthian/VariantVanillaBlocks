...
public class LootTableGenerator extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(Chests.ACACIA_CHEST, this::nameableContainerDrops);
        addDrop(Chests.BAMBOO_CHEST, this::nameableContainerDrops);
        addDrop(Chests.BIRCH_CHEST, this::nameableContainerDrops);
        addDrop(Chests.CHERRY_CHEST, this::nameableContainerDrops);
        addDrop(Chests.CRIMSON_CHEST, this::nameableContainerDrops);
        addDrop(Chests.DARK_OAK_CHEST, this::nameableContainerDrops);
        addDrop(Chests.JUNGLE_CHEST, this::nameableContainerDrops);
        addDrop(Chests.MANGROVE_CHEST, this::nameableContainerDrops);
        addDrop(Chests.SPRUCE_CHEST, this::nameableContainerDrops);
        addDrop(Chests.WARPED_CHEST, this::nameableContainerDrops);
