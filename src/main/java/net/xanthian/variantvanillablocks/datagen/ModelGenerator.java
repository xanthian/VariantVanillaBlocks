...
public class ModelGenerator extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerBuiltin(VariantChests.OAK.getId().withPrefixedPath("block/"), Blocks.OAK_PLANKS).includeWithoutItem(Chests.OAK_CHEST);
    ...
    public void createBarrel(BlockStateModelGenerator blockStateModelGenerator, Block block) {
        ...
        Identifier modelLocation = Identifier.of(identifier.getNamespace(), "block/");
