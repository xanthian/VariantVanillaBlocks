...
import net.xanthian.variantvanillablocks.block.VariantLecternBlock;
...
public class WritableBookItemMixin {
    ...
    boolean variantlecterns$customLecternBlockforWritableBook(BlockState state, Block block, Operation<Boolean> original) {
