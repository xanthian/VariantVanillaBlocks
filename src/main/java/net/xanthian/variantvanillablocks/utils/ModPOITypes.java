...
public class ModPOITypes {
    ...
    public static RegistryObject<PoiType> FISHERMAN = POI_TYPES.register("fisherman", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Barrels.MANGROVE_BARREL, Barrels.OAK_BARREL, Barrels.SPRUCE_BARREL,
    ...
    public static RegistryObject<PoiType> CARTOGRAPHER = POI_TYPES.register("cartographer", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                CartographyTables.CRIMSON_CARTOGRAPHY_TABLE,CartographyTables.DARK_OAK_CARTOGRAPHY_TABLE, CartographyTables.OAK_CARTOGRAPHY_TABLE,
                CartographyTables.JUNGLE_CARTOGRAPHY_TABLE, CartographyTables.MANGROVE_CARTOGRAPHY_TABLE, CartographyTables.SPRUCE_CARTOGRAPHY_TABLE,
                CartographyTables.WARPED_CARTOGRAPHY_TABLE
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> FARMER = POI_TYPES.register("farmer", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Composters.CRIMSON_COMPOSTER, Composters.DARK_OAK_COMPOSTER, Composters.JUNGLE_COMPOSTER,
                Composters.MANGROVE_COMPOSTER, Composters.OAK_COMPOSTER, Composters.SPRUCE_COMPOSTER,
                Composters.WARPED_COMPOSTER
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> FLETCHER = POI_TYPES.register("fletcher", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                FletchingTables.ACACIA_FLETCHING_TABLE, FletchingTables.BAMBOO_FLETCHING_TABLE, FletchingTables.BIRCH_FLETCHING_TABLE,
                FletchingTables.CHERRY_FLETCHING_TABLE, FletchingTables.CRIMSON_FLETCHING_TABLE, FletchingTables.OAK_FLETCHING_TABLE,
                FletchingTables.JUNGLE_FLETCHING_TABLE, FletchingTables.MANGROVE_FLETCHING_TABLE, FletchingTables.SPRUCE_FLETCHING_TABLE,
                FletchingTables.WARPED_FLETCHING_TABLE
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> WEAPONSMITH = POI_TYPES.register("weaponsmith", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Grindstones.CRIMSON_GRINDSTONE, Grindstones.DARK_OAK_GRINDSTONE, Grindstones.JUNGLE_GRINDSTONE,
                Grindstones.MANGROVE_GRINDSTONE, Grindstones.OAK_GRINDSTONE, Grindstones.SPRUCE_GRINDSTONE,
    ...
    public static RegistryObject<PoiType> LIBRARIAN = POI_TYPES.register("librarian", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Lecterns.MANGROVE_LECTERN, Lecterns.OAK_LECTERN, Lecterns.SPRUCE_LECTERN,
                Lecterns.WARPED_LECTERN
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> TOOLSMITH = POI_TYPES.register("toolsmith", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                SmithingTables.CRIMSON_SMITHING_TABLE, SmithingTables.DARK_OAK_SMITHING_TABLE, SmithingTables.JUNGLE_SMITHING_TABLE,
                SmithingTables.MANGROVE_SMITHING_TABLE, SmithingTables.OAK_SMITHING_TABLE, SmithingTables.SPRUCE_SMITHING_TABLE,
                SmithingTables.WARPED_SMITHING_TABLE
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> BUTCHER = POI_TYPES.register("butcher", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Smokers.MANGROVE_SMOKER, Smokers.OAK_SMOKER, Smokers.SPRUCE_SMOKER,
                Smokers.WARPED_SMOKER
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
    ...
    public static RegistryObject<PoiType> BEEHIVE = POI_TYPES.register("beehive", () -> {
        ...
        RegistryObject<Block>[] barrelRegistryObjects = new RegistryObject[]{
                ...
                Beehives.MANGROVE_BEEHIVE, Beehives.OAK_BEEHIVE, Beehives.SPRUCE_BEEHIVE,
                Beehives.WARPED_BEEHIVE
        };
        for (RegistryObject<Block> barrelRegistryObject : barrelRegistryObjects) {
            states.addAll(barrelRegistryObject.get().getStateDefinition().getPossibleStates());
        }
